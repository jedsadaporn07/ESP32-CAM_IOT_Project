...
const char* ssid     = "Tinn";   
const char* password = "tinntinn";   

String myScript = "/macros/s/AKfycbwGfqU3WHnx5Nw_H9BGSJhPcFegGm41QK9gDeIjp-9ydKaiGjfp9d7djY6n_y8S8Qp9/exec";    //Create your Google Apps Script and replace the "myScript" path.
...
String mySpreadsheetId = "&mySpreadsheetId=/spreadsheets/d/1PdnnAZfVuNnX7tEC9mAGjr1pavvd-TjLLGtIfosWYhE/edit#gid=0";  //Google Spreadsheet Id

String myCellRow = "&myCellRow=7";
